...
class Task_custom2:
    ...
    def __create_csv(self, filename: str = "custom2.csv") -> None:
        """
        Method creates csv dataset for first query of type A
        using data from cassandra db

        Args:
            filename (str): filename of csv dataset, defaultly "custom2.csv"
        """

        #TODO


    def plot_graph(self, filename: str = "custom2.png") -> None:
        """
