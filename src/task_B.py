"""
This module implements query of type B specified in assignment
"""
...
class Task_B:
    ...
    def __create_csv(self, filename: str = "B.csv") -> None:
        """
        Method creates csv dataset for first query of type A
        using data from cassandra db

        Args:
            filename (str): filename of csv dataset, defaultly "B.csv"
        """

        #TODO


    def plot_graph(self, filename: str = "B.png") -> None:
        """
